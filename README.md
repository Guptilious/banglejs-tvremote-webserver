# Overview
This project contains all the required scripts to set up a https webserver and devicesearcher for the BangleJS [tvremote watch app](https://github.com/Guptilious/BangleApps/tree/master/apps/tvremote) that I also created. These are required in order for that app to work correctly with your TV. 
